<template>
    <div class="search-container">
        <h1 class="page-title">Movies of Genres</h1>
...
export default {
    ...
    setup() {
        ...
        const fetchData = async () => {
            ...
            const searchurl = `https://api.themoviedb.org/3/discover/movie?api_key=${apiKey}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_genres=${id}&with_watch_monetization_types=flatrate`;
